...
### Changed
- Update `@aegisjsproject/toast-message`
...
### Added
- Add `@aegisjsproject/pwa-prompt`

## [v1.9.5] - 2026-04-17

### Changed
- Another update to `@aegisjsproject/hermes`
...
### Changed
- Update `@shgysk8zer0/kazoo` & `marked`
...
### Added
- Add self (current version) to `importmap.json`
...
### Changed
- Update `@aegisjsproject/markdown`
...
### Changed
- Update `@aegisjsproject/iota` (adds `$html` tagged template)
...
### Changed
- Update `@aegisjsproject/core` and `qr`
...
### Changed
- Update `@aegisjsproject/sanitizer` and related libraries
...
### Changed
- Update `@aegisjsproject/callback-registry`
...
### Changed
- Update `@aegisjsproject/attempt` & `marked`
...
### Changed
- Update `@aegisjsproject/barcodescanenr`
...
### Changed
- Update various `@aegisjsproject` libraries
## [v1.4.53] - 2025-04-02
...
### Changed
- More updates, yet again...

## [v1.4.50] - 2025-03-11

### Changed
- What else? More updates
...
- Change auto-update to Wednesdays

## [v1.4.36] - 2024-12-28

### Added
- Add `leaflet/` to imports
...
### Added
- Add `@aegisjsproject/callback-registry`

### Changed
- Update `@aegisjsproject/core` (now uses callback-registry)
...
### Changed
- Updates to various `@aegisjsproject` libraries
...
### Changed
- Update `@shgysk8zer0/polyfills` and `@aegisjsproject/component`

## [v1.4.15] - 2024-10-08

### Changed
- More version updates again

## [v1.4.14] - 2024-10-04

### Changed
- Updates to CSS parsing & styles

## [v1.4.13] - 2024-09-29

### Changed
- More updates... What else?
...
### Changed
- Bulk update of many package versions

## [v1.4.7] - 2024-09-13

### Changed
- Update `@shgysk8zer0/jwk-utils` and `@shgysk8zer0/polyfills`
...
### Changed
- Update `@shgysk8zer0/components` & `@kernvalley/components`
...
### Added
- Add `@aegisjsproject/parsers`

## [v1.3.8] - 2024-03-27

### Changed
- Important updates to `@aegisjsproject/sanitizer`
...
### Changed
- More updates to library versions

## [v1.3.4] - 2024-03-03

### Changed
- Updated `@aegisjsproject/*`
...
### Changed
- Update `@shgysk8zer0/components`
- Update `@shgysk8zer0/jss`

## [v1.2.3] - 2023-08-23

### Changed
- Update `@shgysk8zer0/polyfills` to v0.2.4
